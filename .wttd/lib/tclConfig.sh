...
# installed.
TCL_PREFIX='/Users/fcp/workspace/1.git/1.django/wttd/.wttd'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/fcp/workspace/1.git/1.django/wttd/.wttd'
...
TCL_EXTRA_CFLAGS='-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Users/fcp/workspace/1.git/1.django/wttd/.wttd/include -fdebug-prefix-map=/Users/runner/miniforge3/conda-bld/tk_1607907272137/work=/usr/local/src/conda/tk-8.6.10 -fdebug-prefix-map=/Users/fcp/workspace/1.git/1.django/wttd/.wttd=/usr/local/src/conda-prefix -pipe  -arch x86_64 -D_FORTIFY_SOURCE=2 -mmacosx-version-min=10.9 -isystem /Users/fcp/workspace/1.git/1.django/wttd/.wttd/include '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/fcp/workspace/1.git/1.django/wttd/.wttd/lib -L/Users/fcp/workspace/1.git/1.django/wttd/.wttd/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/Users/fcp/workspace/1.git/1.django/wttd/.wttd/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/fcp/workspace/1.git/1.django/wttd/.wttd/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/fcp/workspace/1.git/1.django/wttd/.wttd/include'
...
# compiled.
TCL_SRC_DIR='/Users/fcp/workspace/1.git/1.django/wttd/.wttd/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/Users/fcp/workspace/1.git/1.django/wttd/.wttd/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/Users/fcp/workspace/1.git/1.django/wttd/.wttd/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/fcp/workspace/1.git/1.django/wttd/.wttd/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/Users/fcp/workspace/1.git/1.django/wttd/.wttd/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/Users/fcp/workspace/1.git/1.django/wttd/.wttd/lib/libtclstub8.6.a'
